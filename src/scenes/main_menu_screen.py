...
class MainMenuScreen():
    def __init__(self):
        ...
        self.title_text = text.create_text_surface(FontWeight.BOLD, FontSize.XXL, "Ever After", self.text_color)
        self.subtitle_text = text.create_text_surface(FontWeight.MEDIUM, FontSize.SM, "A journey through love.", self.text_color)
    ...
    def draw_screen(self, resource_manager, screen_manager):
        ...
        text.render_text(screen_manager.screen, self.title_text, (90, 60))
        text.render_text(screen_manager.screen, self.subtitle_text, (90, 165))
